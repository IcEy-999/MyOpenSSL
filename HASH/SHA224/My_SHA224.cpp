...
typedef struct _SHA224_Data {
    ...
    PUCHAR Hash_Data;
    _SHA224_Data(PUCHAR M);
}SHA224_Data, * PSHA224_Data;

SHA224_Data::_SHA224_Data(PUCHAR M) {
...
BOOLEAN SHA224_HASH(PSHA224_Data Data) {
...
BOOLEAN Mc_To_W(PSHA224_Data Data) {
    int B_i = Data->Mc_Len_Bit / 512;
